...
central_site_idx = np.argmin([abs(i-24999) for i in mutsim_splind.sites_position]) # changed from 4999 to 24999 when neutral sims were changed from 10kb to 50kb.
