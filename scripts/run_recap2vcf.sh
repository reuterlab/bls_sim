...
# Neutral simulations
qsub -v INDIR='/SAN/reuterlab/balsel_detection/bls_sim/slimout/neutral_N2k_r1e-8/',OUTDIR='/SAN/reuterlab/balsel_detection/bls_sim/vcf/neutral_N2k_r1e-8/',nspl=100,ne=2000 job_recapitate_neutral.sh
