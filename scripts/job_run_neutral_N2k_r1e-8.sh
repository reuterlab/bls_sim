...
/share/apps/SLiM-4.0.1/bin/slim -d jobid=$JOB_ID -d d_seed=$SEED -d d_repID=$REP -d d_folder="'$OUTDIR/'" /SAN/reuterlab/balsel_detection/bls_sim/slim/neutral_N2k_r1e-8.slim
